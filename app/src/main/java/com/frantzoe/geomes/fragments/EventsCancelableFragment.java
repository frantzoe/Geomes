...
public class EventsCancelableFragment extends Fragment implements RecyclerTouchHelper.RecyclerTouchHelperListener {
    ...
    public EventsCancelableFragment() {
        //
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        events = getArguments().getString("navigation").equals("confirmed") ? database.getConfirmedEvents() : database.getEventsByDir(Event.DIR_OUT);
        database.close();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new RecyclerTouchHelper(0, ItemTouchHelper.LEFT, coordinatorLayout, this));
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, final int direction) {
        ...
        Snackbar snackbar = Snackbar.make(coordinatorLayout, "Evènement Annullé!", Snackbar.LENGTH_LONG);
        snackbar.addCallback(new Snackbar.Callback() {
            ...
            public void onDismissed(Snackbar transientBottomBar, int event) {
                if (event == Snackbar.Callback.DISMISS_EVENT_TIMEOUT) {
                    ...
                    Utilities.sendSMS(swipedEvent.getPhone(), "GeoMesCan|" + swipedEvent.getUid() + "|" + swipedEvent.getDirection());
